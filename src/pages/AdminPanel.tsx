    ...
    try {
      const response = await fetch(CREATE_USER_EDGE_FUNCTION_URL, {
        ...
        headers: {
          ...
          'Authorization': `Bearer ${ADMIN_SECRET_KEY}`, // This is for the Edge Function to verify
        },
        body: JSON.stringify({
          email: values.email,
          ...
          admin_secret_key: ADMIN_SECRET_KEY, // Pass the secret key for verification within the Edge Function
        }),
      });
