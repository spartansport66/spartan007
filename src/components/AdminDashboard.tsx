...
import { DollarSign, Users, ShoppingCart, TrendingUp, Loader2, Package, Building, Boxes, Menu, FileText, Info, Gift, Scale, MapPin, Clock, ListChecks } from 'lucide-react';
