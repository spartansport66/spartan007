...
interface UserProfile {
  ...
  user_type: 'admin' | 'sales_person' | 'gate_keeper' | 'inventory_manager' | 'manager';
  is_admin: boolean;
...
const userFormSchema = z.object({
  ...
  userType: z.enum(['admin', 'sales_person', 'gate_keeper', 'inventory_manager', 'manager'], { message: 'Please select a user type.' }),
    ...
    try {
      ...
      const { data: profilesData, error: profilesError } = await supabase
        ...
        .select(`
          ...
          is_admin
        `)
        .neq('user_type', 'admin'); // Filter out admins here
