...
interface BillSalesReportProps {
  isOpen: boolean;
  onOpenChange: (open: boolean) => void;
  onReprint?: (invoiceId: string) => void;
}

export default function BillSalesReport({ isOpen, onOpenChange, onReprint }: BillSalesReportProps) {
  ...
  useEffect(() => {
    applyFilters();
  }, [invoices, billNumberFilter, statusFilter, dateFromFilter, dateToFilter]);
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Sales Bill Report</DialogTitle>
          <DialogDescription>View all generated bills with details and reprint options</DialogDescription>
        </DialogHeader>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 p-4 bg-muted rounded-lg">
          ...
          <div>
            <Label htmlFor="status" className="text-xs">Payment Status</Label>
