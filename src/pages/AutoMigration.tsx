...
CREATE TABLE IF NOT EXISTS public.profiles (id UUID PRIMARY KEY REFERENCES auth.users(id) ON DELETE CASCADE, first_name TEXT, last_name TEXT, avatar_url TEXT, updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(), is_admin BOOLEAN DEFAULT FALSE, user_type TEXT NOT NULL DEFAULT 'sales_person', must_reset_password BOOLEAN DEFAULT FALSE, created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW());
