...
const MultiItemOrderForm: React.FC<MultiItemOrderFormProps> = ({ onOrderPlaced }) => {
  ...
  const disableAddItem = !selectedDealer;
          ...
          <div>
            ...
            <Popover open={isDealerPopoverOpen} onOpenChange={setIsDealerPopoverOpen}>
              <PopoverTrigger asChild>
                <Button variant="outline" role="combobox" aria-expanded={isDealerPopoverOpen} className="w-full justify-between" disabled={dealers.length === 0 || loading}>
                  {currentDealerName}
            ...
            <div className="flex items-end gap-2 p-4 border rounded-md bg-muted/50">
              <div className="flex-grow">
                ...
                <Popover open={isProductPopoverOpen} onOpenChange={setIsProductPopoverOpen}>
                  <PopoverTrigger asChild>
                    <Button variant="outline" role="combobox" className="w-full justify-between" disabled={products.length === 0 || loading || disableAddItem}>
              ...
              <div className="w-24">
                ...
                <Input type="number" value={newItemQuantity} onChange={(e) => setNewItemQuantity(parseInt(e.target.value) || 1)} min="1" disabled={disableAddItem} />
              </div>
